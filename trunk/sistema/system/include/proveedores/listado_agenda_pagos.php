<?php
    ...
    include_once('include/accion_pagar_cuota.php');
    include_once('include/proveedores/agenda_pagos.php');
    include_once('include/proveedores/tabla_agenda_pagos.php');
    ...
    print '<h1>Agenda de pagos a proveedores</h1>';
