<?php
    ...
    class Proveedores extends TableHandler {
        
        public function __construct() {
            parent::__construct('proveedores');
            parent::set_query('SELECT codigo, razon, nombre, domicilio, telefono, provincia, localidad, cp, contacto, pagina, correo, saldo, total FROM proveedores');
        }
