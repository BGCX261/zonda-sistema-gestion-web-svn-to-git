<?php
    ...
    print '<h1>Listado de artículos agrupados por proveedor</h1>';
    ...
    $query .= " ORDER BY proveedores.razon, ".$_REQUEST['orden'];
    ...
    $NombreCampos = array('Proveedor', 'Código', 'Descripción', 'Categoría', 'Existencia');
