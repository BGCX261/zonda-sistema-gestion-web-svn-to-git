<?php
    ...
    class Campo {
        ...
        public function __construct($name, $value, $label, $type) {
            ...
            $this->label = $label;
            $this->type = $type;
            $this->class = 'campo campo-entrada campo-flat';
        }
        ...
        public function set_placeholder($ph) {
            $this->placeholder = 'placeholder="'.$ph.'"';
        }
        ...
        public function show() {
            ...
            print '<input type="'.$this->type.'" name="'.$this->name.'" class="'.$this->class.'" '.$this->size.' '.$this->maxlength.' '.$this->placeholder.' value="'.$this->value.'" '.$this->required.' '.$this->readonly.' '.$this->disabled.' '.$this->parameters.' />';
        }
