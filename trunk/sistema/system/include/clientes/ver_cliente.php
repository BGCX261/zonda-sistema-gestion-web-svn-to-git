...
<div class="grupo-campos grupo-campos-chico">
    <img class="imagen imagen-chica" src="<?php empty($registro[18]) ? print 'images/sin-imagen.png' : print $registro[18]; ?>" />
</div>
...
<div class="grupo-campos grupo-campos-chico">
    ...
    <p class="contenido-campo-small"><?php print $listas->get_descripcion_lista($registro[14]); ?></p>
    <p class="titulo-campo">Lista de precios</p>
</div>